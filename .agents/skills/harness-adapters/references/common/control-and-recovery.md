...
Grok renders a folder-trust gate in a linked worktree, and `references/harness/grok.md` owns how to verify the worker's real location and answer it; the project picker is a separate dialog that stays absent when the spawn starts in a git root.
